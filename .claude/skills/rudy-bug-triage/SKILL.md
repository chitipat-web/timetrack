...
Run the rudy-deploy skill. Bump version, push all three files, then ask the user to clear cache. **Don't** try to patch a broken deploy with a partial commit — bump the version again and ship all three files cleanly.
